...
# On-board Buttons
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS25} [get_ports {btnd}]
...
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports {aud_out}]
set_property -dict {PACKAGE_PIN B14 IOSTANDARD LVCMOS33} [get_ports {aud_out}]
