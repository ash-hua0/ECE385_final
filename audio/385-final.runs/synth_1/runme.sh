...
HD_PWD='C:/Users/Orion/Downloads/385-final/385-final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_top.tcl
