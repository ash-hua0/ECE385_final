...
HD_PWD='C:/Users/Orion/Downloads/385-final/385-final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_top.tcl -notrace
