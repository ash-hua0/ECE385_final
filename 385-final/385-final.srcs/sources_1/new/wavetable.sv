...
// (255/2)sin(x/10)+(255/2), it is 255/2 because you have 8b output
// represents one 64-sample period
module wavetable(input[5:0] phase_in, input clk_in, output logic[7:0] amp_out);
  always_ff @(posedge clk_in)begin
    case(phase_in) // TODO: expand bits to 12 for better quality audio
    // TODO can make this memory instead of this weird MUX/register file?
      6'd0: amp_out<=8'd128;
      6'd1: amp_out<=8'd140;
      6'd2: amp_out<=8'd152;
      6'd3: amp_out<=8'd165;
